    ...
    def Saving(s):
         if(ChosenLanguage=="Python"):
            with open('main.py', 'w') as f:
                ...
                f.write(TEXT)
         elif(ChosenLanguage=="CSharp"):
            with open('C#main.cs', 'w') as f:
                TEXT = text.toPlainText()
                f.write(TEXT)
...
#        Port.addAction(Port_Action)
        ...
        Python_Action.triggered.connect(self.PythonLanguage)
        CSharp_Action=QAction("C#",self)
        CSharp_Action.triggered.connect(self.CSharpLanguage)
...
#            ide.upload_file(self.portNo)
    ...
    def CSharpLanguage(self):
       global ChosenLanguage 
       ChosenLanguage="CSharp" 
       CSharp_Coloring.CSharpHighlighter(text)
       
       
    def PythonLanguage(self):
       global ChosenLanguage 
